...
for md in mods:
        ...
        for cluster in clusters:
                ...
                s = setup(data, target = 'Rentabilidade 3M', session_id=123, transformation = True, transformation_method='quantile', train_size=0.8)
                #s = setup(data, target = 'Rentabilidade 3M', session_id=123, feature_selection=True, transformation = True, transformation_method='quantile', train_size=0.8)
                #s = setup(data, target = 'Rentabilidade 3M', session_id=123, feature_selection=True, transformation = True, transformation_method='quantile')
                #s = setup(data, target = 'Rentabilidade 3M', session_id=123, transformation = True, transformation_method='quantile')
                #s = setup(data, target = 'Rentabilidade 3M', session_id=123)
                ...
                # data_teste['Cluster'].loc[ data_teste['Rentabilidade 3 meses'] < (data_teste['Rentabilidade 3 meses'].mean() - 0.5*data_teste['Rentabilidade 3 meses'].std())] = -1.0
                # data_teste['Cluster'].loc[ data_teste['Rentabilidade 3 meses'] > (data_teste['Rentabilidade 3 meses'].mean() + 0.5*data_teste['Rentabilidade 3 meses'].std())] =  1.0
                ...
                # Evaluating the model
                mse1 = mean_squared_error(unseen_predictions['Rentabilidade 3M'], unseen_predictions['prediction_label'])    
                r21 = r2_score(unseen_predictions['Rentabilidade 3M'], unseen_predictions['prediction_label'])
                ...
                mse2 = mean_squared_error(unseen_predictions['Rentabilidade 3M'], unseen_predictions['prediction_label'])    
                r22 = r2_score(unseen_predictions['Rentabilidade 3M'], unseen_predictions['prediction_label'])
