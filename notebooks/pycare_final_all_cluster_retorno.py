...
for cluster in clusters:
        ...
        for md in mods:
                ...
                data0 = pd.read_csv('data/processed/kmeans_cluster2.csv', index_col=0)
                data0['Cluster'] = 0
                data0['Cluster'].loc[ data0['Rentabilidade 3 meses'] < data0['Rentabilidade 3 meses'].mean()*0.85] = -1.0
                data0['Cluster'].loc[ data0['Rentabilidade 3 meses'] > data0['Rentabilidade 3 meses'].mean()*1.10] =  1.0
